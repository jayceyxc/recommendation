...
if __name__ == "__main__":
    # getRatings("recommend_sys_practice/data/bookcrossings/BX-Book-Ratings.csv")
    getBooksMess("recommend_sys_practice/data/bookcrossings/BX-Books.csv")
    # getUsersMess("recommend_sys_practice/data/bookcrossings/BX-Users.csv")
