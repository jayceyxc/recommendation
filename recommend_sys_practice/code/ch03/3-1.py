...
def getUsers(file_path):
    ...
    print("userID的范围为: <{},{}>".format(
        min(users["userID"]), max(users["userID"])))
    print("数据总条数为:\n{}".format(users.count()))
...
if __name__ == "__main__":
    # getRatings("recommend_sys_practice/data/ml-1m/ratings.dat")
    # getMovies("recommend_sys_practice/data/ml-1m/movies.dat")
    getUsers("recommend_sys_practice/data/ml-1m/users.dat")
